...
export const translations = {
  ru: {
    ...
    calendar: {
      ...
      appointmentsToday: "записей сегодня",
      services: "Услуги",
      activeServices: "активных услуг",
      staff: "Сотрудники",
      activeStaff: "активных сотрудников",
      addStaffFirst: "Добавьте сначала сотрудников для работы с календарем",
    ...
    messages: {
      ...
      requireResponse: "требуют ответа",
      activity: "Активность",
      last24Hours: "за последние 24 часа",
      noActiveChats: "Нет активных чатов",
      chatsAutoCreated: "Чаты создаются автоматически при обращении клиентов",
      allChats: "Все чаты",
    ...
    settings: {
      title: "Настройки",
      manageSettings: "Управление настройками аккаунта и компании",
      personalInfo: "Личная информация",
      updateProfile: "Обновите свои личные данные",
      fullName: "Полное имя",
      email: "Email",
      phone: "Телефон",
      ...
      manageCompany: "Управление данными компании",
      ...
      paid: "Оплатили",
      totalPaid: "всего оплатили",
      earned: "Заработано",
      totalEarned: "всего заработано",
      yourReferralLink: "Ваша реферальная ссылка",
      shareReferralLink: "Поделитесь ссылкой с друзьями и партнерами",
      shareYourLink: "Поделитесь ссылкой с друзьями",
      referralRegisters: "Друг регистрируется и оплачивает подписку",
      payoutsMonthly: "Выплаты происходят ежемесячно",
      pendingEarnings: "Ожидает выплаты",
      payoutAfterConfirmation: "Выплата произойдет после подтверждения платежа",
      referralsList: "Список ваших рефералов",
      registrationDate: "Дата регистрации",
      commission: "Комиссия",
      registered: "Зарегистрирован",
      payoutHistory: "История выплат",
      last10Payouts: "Последние 10 выплат",
      date: "Дата",
      notificationsSettings: "Настройки уведомлений",
      manageNotifications: "Управление уведомлениями",
      emailNotifications: "Email уведомления",
      receiveEmailNotifications: "Получать уведомления на email",
      pushNotifications: "Push уведомления",
      receivePushNotifications: "Получать push-уведомления",
      newCustomers: "Новые клиенты",
      notifyNewCustomers: "Уведомлять о новых клиентах",
      newDeals: "Новые сделки",
      notifyNewDeals: "Уведомлять о новых сделках",
      securitySettings: "Настройки безопасности",
      manageAccountSecurity: "Управление безопасностью аккаунта",
      currentPassword: "Текущий пароль",
      newPassword: "Новый пароль",
      confirmPassword: "Подтвердите пароль",
      addSecurityLayer: "Добавить дополнительный уровень защиты",
    },
    ...
    getCodeViaWhatsApp: "Получите код через WhatsApp",
    referralStep1: "Напишите ПРОМОКОД в WhatsApp",
    referralStep2: "Получите свой уникальный код",
    referralStep3: "Поделитесь кодом с клиентами",
    referralStep4: "Получайте бонусы за покупки",
    sendKeyword: "Отправьте ключевое слово",
    toGetCode: "чтобы получить промокод",
    referralHistory: "История начислений",
    referredClient: "Реферальный клиент",
  ...
  kk: {
    ...
    calendar: {
      ...
      subtitle: "Кездесулер мен кестені басқару",
      ...
      appointmentsToday: "бүгінгі жазулар",
      services: "Қызметтер",
      activeServices: "белсенді қызметтер",
      staff: "Қызметкерлер",
      activeStaff: "белсенді қызметкерлер",
      addStaffFirst: "Күнтізбемен жұмыс істеу үшін алдымен қызметкерлерді қосыңыз",
      noUpcomingAppointments: "Алдағы жазулар жоқ",
      upcomingAppointments: "Алдағы жазулар",
    },

    messages: {
      title: "Хабарламалар",
      description: "Барлық әңгімелеріңіз бір жерде",
      subtitle: "Барлық чаттарыңыз бір жерде",
      noMessages: "Хабарламалар жоқ",
      justNow: "Жаңа ғана",
      typeMessage: "Хабарлама жазыңыз...",
      sendMessage: "Жіберу",
      totalChats: "Барлық чаттар",
      activeDialogs: "белсенді диалогтар",
      unread: "Оқылмаған",
      requireResponse: "жауап қажет",
      activity: "Белсенділік",
      last24Hours: "соңғы 24 сағатта",
      noActiveChats: "Белсенді чаттар жоқ",
      chatsAutoCreated: "Чаттар клиенттер жүгінген кезде автоматты түрде жасалады",
      allChats: "Барлық чаттар",
      unknownClient: "Белгісіз клиент",
      minAgo: "мин. бұрын",
      hourAgo: "сағ. бұрын",
      dayAgo: "күн бұрын",
    },
    ...
    settings: {
      title: "Баптаулар",
      manageSettings: "Аккаунт пен компания баптауларын басқару",
      personalInfo: "Жеке ақпарат",
      updateProfile: "Жеке деректеріңізді жаңартыңыз",
      fullName: "Толық аты",
      email: "Email",
      phone: "Телефон",
      ...
      manageCompany: "Компания деректерін басқару",
      ...
      moscow: "Мәскеу (GMT+3)",
      clicks: "Өтулер",
      totalClicks: "барлық өтулер",
      registrations: "Тіркелулер",
      registeredUsers: "тіркелген пайдаланушылар",
      paid: "Төледі",
      totalPaid: "барлығы төледі",
      earned: "Табылды",
      totalEarned: "барлығы табылды",
      yourReferralLink: "Сіздің реферал сілтемеңіз",
      shareReferralLink: "Достарыңыз бен серіктестеріңізбен сілтемені бөлісіңіз",
      shareYourLink: "Достарыңызбен сілтемені бөлісіңіз",
      referralRegisters: "Дос тіркеледі және жазылымға ақы төлейді",
      payoutsMonthly: "Төлемдер ай сайын жүреді",
      pendingEarnings: "Төлемді күтуде",
      payoutAfterConfirmation: "Төлем растағаннан кейін жүреді",
      referralsList: "Сіздің рефералдарыңыздың тізімі",
      registrationDate: "Тіркелу күні",
      commission: "Комиссия",
      registered: "Тіркелді",
      payoutHistory: "Төлемдер тарихы",
      last10Payouts: "Соңғы 10 төлем",
      date: "Күні",
      notificationsSettings: "Хабарландырулар баптаулары",
      manageNotifications: "Хабарландыруларды басқару",
      emailNotifications: "Email хабарландырулары",
      receiveEmailNotifications: "Email-ге хабарландырулар алу",
      pushNotifications: "Push хабарландырулары",
      receivePushNotifications: "Push-хабарландырулар алу",
      newCustomers: "Жаңа клиенттер",
      notifyNewCustomers: "Жаңа клиенттер туралы хабарландыру",
      newDeals: "Жаңа мәмілелер",
      notifyNewDeals: "Жаңа мәмілелер туралы хабарландыру",
      securitySettings: "Қауіпсіздік баптаулары",
      manageAccountSecurity: "Аккаунт қауіпсіздігін басқару",
      currentPassword: "Ағымдағы құпия сөз",
      newPassword: "Жаңа құпия сөз",
      confirmPassword: "Құпия сөзді растаңыз",
      addSecurityLayer: "Қосымша қорғаныс деңгейін қосу",
    },
    ...
    // Referral System
    referralStats: "Рефералдар статистикасы",
    bonusBalance: "Бонустар балансы",
    getCodeViaWhatsApp: "WhatsApp арқылы код алыңыз",
    referralStep1: "WhatsApp-қа ПРОМОКОД жазыңыз",
    referralStep2: "Өзіңіздің бірегей кодыңызды алыңыз",
    referralStep3: "Кодты клиенттермен бөлісіңіз",
    referralStep4: "Сатып алулар үшін бонустар алыңыз",
    sendKeyword: "Кілт сөзді жіберіңіз",
    toGetCode: "промокод алу үшін",
    referralHistory: "Есептеулер тарихы",
    referredClient: "Реферал клиенті",
    saleAmount: "Сату сомасы",
    saleCommission: "Сатудан комиссия",
