...
export default function KaspiCRMPage() {
    ...
    <div className="min-h-screen">
      ...
      <section className="container py-20 md:py-32">
        <div className="mx-auto max-w-4xl text-center space-y-8">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-balance">{t.kaspiHeroTitle}</h1>
      ...
      <section className="bg-secondary/30 py-20 md:py-32">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <FeatureItem icon={LinkIcon} title={t.kaspiFeature1} description={t.kaspiFeature1Desc} />
            <FeatureItem icon={Bell} title={t.kaspiFeature2} description={t.kaspiFeature2Desc} />
            <FeatureItem icon={Bot} title={t.kaspiFeature3} description={t.kaspiFeature3Desc} />
            <FeatureItem icon={MessageSquare} title={t.kaspiFeature4} description={t.kaspiFeature4Desc} />
            <FeatureItem icon={FileCheck} title={t.kaspiFeature5} description={t.kaspiFeature5Desc} />
            <FeatureItem icon={TrendingUp} title={t.kaspiFeature6} description={t.kaspiFeature6Desc} />
            <FeatureItem icon={BarChart3} title={t.kaspiFeature7} description={t.kaspiFeature7Desc} />
            <FeatureItem icon={Users} title={t.kaspiFeature8} description={t.kaspiFeature8Desc} />
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          <Card>
            <CardContent className="pt-6 text-center space-y-4">
              ...
              <h3 className="font-bold text-lg">{t.kaspiStep1Title}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t.kaspiStep1Desc}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center space-y-4">
              ...
              <h3 className="font-bold text-lg">{t.kaspiStep2Title}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t.kaspiStep2Desc}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center space-y-4">
              ...
              <h3 className="font-bold text-lg">{t.kaspiStep3Title}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t.kaspiStep3Desc}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6 text-center space-y-4">
              ...
              <h3 className="font-bold text-lg">{t.kaspiStep4Title}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t.kaspiStep4Desc}</p>
            </CardContent>
          </Card>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <PricingCard
              title={t.basicPlan}
              price={t.basicPrice}
              features={[t.kaspiBasicFeature1, t.kaspiBasicFeature2, t.kaspiBasicFeature3]}
            />
            <PricingCard
              title={t.standardPlan}
              price={t.kaspiStandardPrice}
              badge={`⭐ ${t.kaspiStandardBadge}`}
              features={[t.standardFeature1, t.kaspiStandardFeature2, t.kaspiStandardFeature3, t.kaspiStandardFeature4]}
            />
            <PricingCard
              title={t.businessPlan}
              price={t.kaspiBusinessPrice}
              features={[t.businessFeature1, t.kaspiBusinessFeature2, t.kaspiBusinessFeature3, t.kaspiBusinessFeature4]}
            />
          </div>
        </div>
      </section>
      ...
      <section className="container py-20">
        ...
        <p className="text-lg text-center text-muted-foreground max-w-4xl mx-auto leading-relaxed">{t.kaspiTarget}</p>
      </section>

      {/* Special Note Section */}
      <section className="bg-warning/10 py-16">
        <div className="container max-w-3xl mx-auto text-center space-y-4">
          <Badge className="bg-warning text-warning-foreground text-base px-4 py-2">{t.kaspiSpecialNote}</Badge>
          <p className="text-muted-foreground leading-relaxed">{t.kaspiSpecialDesc}</p>
        </div>
      </section>
      ...
      <section className="container py-20 md:py-32">
        ...
        <Accordion type="single" collapsible className="max-w-3xl mx-auto">
          ...
          <FaqItem question={t.faq6Q} answer={t.faq6A} value="faq-6" />
